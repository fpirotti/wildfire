...
todos <- list(
"CZ-AT" = list( pred  = terra::rast("/archivio/shared/geodati/wildfire/pilotRegions/pilotRegions_CZ-DE_FuelModel.tif") ,
                obs = terra::rast("data/validation/WildfireCE_Fuel_map_validation_AT-CZ_CzechGlobe_model.tif") 
            ),

"DE-CZ" = list(pred = terra::rast("/archivio/shared/geodati/wildfire/pilotRegions/pilotRegions_CZ-DE_FuelModel.tif"), 
